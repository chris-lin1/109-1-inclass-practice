...
```{r ans11}
# Info_UserData
user_grade <- factor(Info_UserData$user_grade,
...
Info_UserData$gender[User_Counts_with_gender_NA]
39853
...
best_performance_dpp <- list(
 name = "貢寮區" , 
 votes  = round(election2020$有效票數[[26]]*election2020$`(3)
 蔡英文
 賴清德`[[26]]) , 
...
# election2020[["鄉(鎮、市、區)別"]]
 sum(as.integer(election2020$有效票數)) -> totalVotes 
totalVotes
```
